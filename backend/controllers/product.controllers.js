...
export const deleteProduct = async (req,res) => {
    try {
        ...
        console.log(error.message,"error in deleteProduct controller");
        res.status(500).json({message:error.message})
    }
}
export const getRecommendedProducts = async (req,res) => {
    try {
        ...
        console.log(error.message,"error in getRecommendedProducts controller");
        res.status(500).json({message:error.message})
    }
...
export const getProductsbyCategory = async (req,res) => {
    ...
    try {
        ...
        console.log(error.message,"error in getProductsbyCategory controller");
        res.status(500).json({message:error.message})
