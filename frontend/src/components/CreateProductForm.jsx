        ...
        >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        className="mt-1 block w-full bg-gray-700 border-gray-600 rounded-md shadow-sm py-2 px- text-white
            ...
            focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                ...
                <div className="mt-1 flex items center">
                    ...
                    >
                        <Upload className="w-5 h-5 mr-2 inline-block" /> Upload Image
                    </label>
